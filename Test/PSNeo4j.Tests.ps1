...
Describe "Set-Neo4jNode $PSVersion" {
    ...
    It 'Should create a well formed MERGE query with no label specified' {
    ...
    It 'Should create a well formed MATCH query if NoCreate is specified and with no label specified' {
